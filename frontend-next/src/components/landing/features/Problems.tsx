    ...
    <section className="py-32 bg-black relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-screen-2xl mx-auto px-4 md:px-8 relative z-10">
        <motion.div
          ...
          whileInView="visible"
          viewport={{ once: true }}
          className="text-left mb-24 space-y-8"
        >
          <motion.div
          ...
          >
            ...
            <span className="text-[11px] font-black uppercase tracking-[0.5em] text-red-500/60">
              The Real Problems
            </span>
          </motion.div>
          ...
          <motion.p
            variants={itemVariants}
            className="text-xl md:text-2xl text-zinc-600 max-w-3xl font-medium leading-relaxed italic"
          >
          ...
          {problems.map((item, idx) => (
            ...
            >
              ...
              <div className="space-y-4 text-left">
                <h3 className="text-3xl font-black text-white uppercase tracking-tighter leading-none group-hover:text-red-500 transition-colors duration-700">
                  {item.title}
                </h3>
                <p className="text-zinc-600 text-lg font-medium leading-relaxed italic group-hover:text-zinc-400 transition-colors duration-700">
                  {item.desc}
                </p>
              </div>
            </motion.div>
