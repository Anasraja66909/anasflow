        ...
        >
          ...
          >
            ...
            <span className="text-[11px] font-black uppercase tracking-[0.5em] text-indigo-400">
              AI Cost & Automation Control Hub
            </span>
          </motion.div>
          ...
          <motion.div
            variants={itemVariants}
            className="relative mb-20 max-w-2xl min-h-[120px]"
          >
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className="text-xl md:text-2xl text-zinc-500 leading-relaxed font-medium italic absolute"
              >
          ...
          >
            <Link
              href="/dashboard"
              className="w-full sm:w-auto px-12 py-8 bg-white text-black font-black text-[11px] uppercase tracking-[0.4em] rounded-[2rem] hover:bg-[#00E5C0] transition-all duration-700 shadow-[0_40px_100px_rgba(0,0,0,0.5)] hover:shadow-[#00E5C0]/40 group active:scale-95"
            >
              Start Free Now
            </Link>
            <button className="w-full sm:w-auto px-12 py-8 bg-zinc-950/40 backdrop-blur-3xl border border-white/5 text-white font-black text-[11px] uppercase tracking-[0.4em] rounded-[2rem] hover:bg-white/5 transition-all duration-700 flex items-center justify-center gap-4 group active:scale-95">
          ...
          <motion.div
            variants={itemVariants}
            className="flex items-center gap-6 text-[10px] text-zinc-700 font-black uppercase tracking-[0.3em]"
          >
        ...
        >
          ...
          >
            ...
            <div className="absolute top-[5%] -left-12 w-20 h-20 rounded-3xl bg-zinc-950/60 border border-white/5 backdrop-blur-xl flex flex-col items-center justify-center shadow-3xl animate-pulse">
              ...
              <span className="text-[8px] font-black text-zinc-600 mt-1">
                ROI
              </span>
            </div>
            ...
            <div className="w-full lg:w-[130%] bg-zinc-950/40 backdrop-blur-[60px] border border-white/5 rounded-[4rem] overflow-hidden shadow-[0_80px_200px_rgba(0,0,0,0.8)] relative z-10 transition-transform duration-1000 group/mockup hover:scale-105">
              ...
              <div className="p-12 space-y-10 relative">
                ...
                {/* Master Spend Diagnostic */}
                <div className="bg-black/40 rounded-[2.5rem] p-10 border border-white/5 shadow-inner relative overflow-hidden group/stat">
                ...
                <div className="grid grid-cols-2 gap-8">
                  ...
                  {/* Money You Can Save */}
                  <div className="bg-[#00E5C0]/5 rounded-[2.5rem] p-8 border border-[#00E5C0]/20 shadow-inner flex flex-col justify-center items-center gap-4 group/opt">
                    <Sparkles className="w-10 h-10 text-[#00E5C0] group-hover/opt:scale-110 transition-transform duration-700" />
                ...
                <div className="pt-6 flex items-center justify-between border-t border-white/5">
                  ...
                  <span className="text-[9px] font-black text-zinc-800 uppercase tracking-widest italic">
                    AnasFlow v4.2 Stable
                  </span>
                </div>
              </div>
            </div>
